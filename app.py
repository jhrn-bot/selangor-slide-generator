...
def generate_pptx():
    ...
    try:
        ...
        st.warning(f"Could not fetch Google Slides directly: {e}. Generating standalone title slide.")
        prs = Presentation()
    ...
    if os.path.exists("qr.png"):
        slide.shapes.add_picture("qr.png", Inches(10.35), Inches(4.55), width=Inches(2.2))
...
if st.button("🚀 Generate Slide Deck", type="primary", use_container_width=True):
    ...
    st.success(f"Slide deck generated with custom Slide 1 for ME {epi_week:02d} / {year}!")
